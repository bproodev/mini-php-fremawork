          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                    @if(session_get('username'))
                        <span class="font-weight-bold mb-2">{{session_get('username')}}</span>
                    @else
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                ...
                <a class="dropdown-item" href="{{BASE_PATH}}/admin/logout">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="{{BASE_PATH}}/admin/products/create">Ajouter Produits</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{BASE_PATH}}/admin/products">Liste Produits</a>
                    </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{BASE_PATH}}/produits">
                <span class="menu-title">Visitez la boutique</span>
                <i class="mdi mdi-home fa fa-share-square-o"></i>
              </a>
            </li>
          </ul>
        </nav>
