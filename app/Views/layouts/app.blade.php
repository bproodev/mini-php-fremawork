  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
			...
			<div class="container">
				<a class="navbar-brand" href="{{BASE_PATH}}/">Bproo<span>Decor</span></a>
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li><a class="nav-link" href="{{BASE_PATH}}/produits">Products</a></li>
						<li><a class="nav-link" href="{{BASE_PATH}}/about">About us</a></li>
						<li><a class="nav-link" href="{{BASE_PATH}}/services">Services</a></li>
						<li><a class="nav-link" href="{{BASE_PATH}}/produit">Produit</a></li>
						<li><a class="nav-link" href="{{BASE_PATH}}/contact">Contact us</a></li>
					</ul>
